...
export interface GovernerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "campaign"
      | "cancel"
...
export interface Governer extends BaseContract {
  connect(runner?: ContractRunner | null): Governer;
  waitForDeployment(): Promise<this>;

  interface: GovernerInterface;
