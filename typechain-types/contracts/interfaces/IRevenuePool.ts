...
export interface IRevenuePoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "claimed"
      | "governor"
...
export interface IRevenuePool extends BaseContract {
  connect(runner?: ContractRunner | null): IRevenuePool;
  waitForDeployment(): Promise<this>;

  interface: IRevenuePoolInterface;
