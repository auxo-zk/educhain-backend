...
export interface IRevenuePoolFactoryInterface extends Interface {
  getFunction(
...
export interface IRevenuePoolFactory extends BaseContract {
  connect(runner?: ContractRunner | null): IRevenuePoolFactory;
  waitForDeployment(): Promise<this>;

  interface: IRevenuePoolFactoryInterface;
